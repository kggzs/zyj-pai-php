...
[![License](https://img.shields.io/badge/License-学习使用专用-red.svg)](LICENSE)
...
- 📘 [UploadHelper使用说明](docs/upload-helper使用说明.md) - 图片/视频上传助手使用文档
...
**本项目仅供学习和研究使用，严禁用于商业用途或进行任何形式的二次修改。**

**⚠️ 隐私获取免责声明：**

本项目涉及获取他人隐私信息的功能（包括但不限于拍摄照片、视频、获取位置信息等）。在使用本项目时，**您必须确保已获得所有相关人员的明确同意和授权**。如果您无法获得他人同意，**请立即停止使用并删除本项目**。项目作者不对因使用本项目而产生的任何隐私侵权、法律责任或损害承担任何责任。使用者应自行承担因使用本项目而产生的所有法律责任。

### 📋 使用限制

1. **仅限学习使用**：本项目代码仅供个人学习、研究、教育目的使用。
2. **禁止商业使用**：严禁将本项目用于任何商业目的，包括但不限于：
   - 商业运营
   - 商业服务提供
   - 商业产品开发
   - 任何形式的盈利活动
3. **禁止二次修改**：严禁对本项目进行任何形式的修改、改编、衍生开发，包括但不限于：
   - 修改源代码
   - 基于本项目开发新项目
   - 将本项目代码整合到其他项目中
   - 对项目进行任何形式的二次开发
4. **禁止分发**：严禁以任何形式分发、传播本项目代码。
...
- ✅ 遵守《个人信息保护法》等相关法律法规
- ✅ 严禁未经同意获取、使用他人隐私信息
- ✅ 如无法获得他人同意，立即停止使用并删除项目

**项目作者不承担任何隐私侵权相关的法律责任。**

### 📜 完整协议

详细的使用协议请查看：[LICENSE](LICENSE) 文件。

**使用本项目即表示您已阅读、理解并同意遵守上述所有限制条款。违反上述条款的行为将承担相应的法律责任。**
