 ...
 * 详细使用协议请查看 LICENSE 文件。
 * 
 * ⚠️ 隐私获取免责声明：
 * 本项目涉及获取他人隐私信息的功能。在使用本项目时，您必须确保已获得所有相关人员的明确同意和授权。
 * 如果您无法获得他人同意，请立即停止使用并删除本项目。
 * 项目作者不对因使用本项目而产生的任何隐私侵权、法律责任或损害承担任何责任。
 * 
 * 使用本项目即表示您已阅读、理解并同意遵守 LICENSE 文件中的所有条款。
 */
session_start();
